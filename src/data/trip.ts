...
export const TRIP_DATA: TripData = {
  ...
  stops: [
    ...
    },
    {
      ...
      slug: "prince-albert",
      name: "Prince Albert",
      accommodation: "Wolvekraal Campsite",
      accommodationType: "campsite",
      coordinates: { lat: -33.2276, lng: 22.0297 },
      dates: "Thu 9 – Fri 10 April",
      nights: 2,
      description:
        "Camping at Wolvekraal Guest Farm, perched on a koppie just 10 minutes outside Prince Albert with 360° views of both the Swartberg mountain range and the Karoo plains. One of the most visually dramatic campsite settings in the Karoo — the sunsets and starscapes here are exceptional. Prince Albert itself is arguably the most beautiful small town in the Great Karoo, with Victorian architecture, excellent restaurants, olive groves, and the Swartberg Pass literally 5km from the front door.",
      landscapeDescription:
      ...
      features: [
        ...
        "Swimming pool",
        "Hot showers & ablutions",
        "Near Prince Albert village",
      ],
      bookingSource: "Direct booking",
      bookingUrl: "https://wolvekraal.co.za/camping/",
      imageUrl: "/images/stops/Prince Albert/campsite4-hero.jpg",
      driveFromPrevious: {
        distanceKm: 200,
        durationHours: 3,
        description:
